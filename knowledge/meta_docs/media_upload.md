...
Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/flows/reference/media_upload
...
The media can be downloaded following the same steps as for regular image and document messages.
